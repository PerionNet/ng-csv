  ...
  describe('charset attribute', function () {
    ...
    it('is UTF-8 as default', function () {
      ...
      window.URL.createObjectURL = function (blob) {
        ...
        expect(blob.type || blob.typeForTest()).toBe("application/octet-stream;charset=utf-8;");
      };
    ...
    it('can be set to UTF-8', function () {
      ...
      window.URL.createObjectURL = function (blob) {
        expect(blob.type).toBe("application/octet-stream;charset=utf-8;");
      };
    ...
    it('can be set to ISO-8859-1', function () {
      ...
      window.URL.createObjectURL = function (blob) {
        expect(blob.type).toBe("application/octet-stream;charset=iso-8859-1;");
      };
